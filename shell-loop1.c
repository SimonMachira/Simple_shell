...
/**
 * find_cmd - function to find command in PATH
 *
 *
...
/**
 * Fork system call  used to create a new process, called child process,
 *  running  concurrently with process making the fork() call (parent process).
 */
